...
import { ContadorComponent } from 'app/entities/contador/contador.component';
...
describe('Component Tests', () => {
  describe('Contador Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contadors && comp.contadors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
