...
import { ParceiroComponent } from 'app/entities/parceiro/parceiro.component';
...
describe('Component Tests', () => {
  describe('Parceiro Management Component', () => {
    let comp: ParceiroComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ParceiroComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.parceiros && comp.parceiros[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
