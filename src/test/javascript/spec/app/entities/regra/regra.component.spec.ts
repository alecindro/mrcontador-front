...
import { RegraComponent } from 'app/entities/regra/regra.component';
import { RegraService } from 'app/entities/regra/regra.service';
import { Regra } from 'app/shared/model/regra.model';

describe('Component Tests', () => {
  describe('Regra Management Component', () => {
    let comp: RegraComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RegraComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.regras && comp.regras[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
