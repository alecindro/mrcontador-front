...
import { ExtratoComponent } from 'app/entities/extrato/extrato.component';
import { ExtratoService } from 'app/entities/extrato/extrato.service';
import { Extrato } from 'app/shared/model/extrato.model';

describe('Component Tests', () => {
  describe('Extrato Management Component', () => {
    let comp: ExtratoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExtratoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.extratoes && comp.extratoes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
