...
export class ArquivoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.arquivoService
      ...
      .subscribe(
        (res: HttpResponse<IArquivo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IArquivo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
