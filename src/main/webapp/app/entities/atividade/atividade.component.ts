...
export class AtividadeComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.atividadeService
      ...
      .subscribe(
        (res: HttpResponse<IAtividade[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  trackId(index: number, item: IAtividade): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInAtividades(): void {
    this.eventSubscriber = this.eventManager.subscribe('atividadeListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAtividade[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
