...
export class ContadorComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contadorService
      ...
      .subscribe(
        (res: HttpResponse<IContador[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInContadors();
  }
  ...
  trackId(index: number, item: IContador): number {
    // eslint-disable-next-line @typescript-eslint/no-unnecessary-type-assertion
    return item.id!;
  }

  registerChangeInContadors(): void {
    this.eventSubscriber = this.eventManager.subscribe('contadorListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IContador[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
